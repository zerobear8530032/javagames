...
import ButtonInterface.OperatorButtonInterface;

public class Substract implements OperatorButtonInterface{
	int uses;
	int price;
	boolean usable;
	JButton button;
...
//	}
	...
	public Substract(int uses, int price, boolean usable, JButton button) {
		this.uses = uses;
		this.price = price;
		this.usable = usable;
		this.button = button;
